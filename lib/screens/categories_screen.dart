...
class _CategoriesScreenState extends State<CategoriesScreen> {
  ...
  final Map<String, List<Map<String, dynamic>>> _categoryProducts = {
    'Fruits': [
      ...
      {'name': 'Tomato', 'price': 30, 'unit': '500g', 'category': 'Fruits', 'image': 'assets/images/products/vegetable1.png'},
      {'name': 'Potato', 'price': 25, 'unit': '1kg', 'category': 'Fruits', 'image': 'assets/images/products/vegetable2.png'},
      {'name': 'Onion', 'price': 35, 'unit': '1kg', 'category': 'Fruits', 'image': 'assets/images/products/vegetable3.png'},
      {'name': 'Broccoli', 'price': 60, 'unit': '500g', 'category': 'Fruits', 'image': 'assets/images/products/vegetable1.png'},
      {'name': 'Capsicum', 'price': 40, 'unit': '500g', 'category': 'Fruits', 'image': 'assets/images/products/vegetable2.png'},
    ],
    ...
    'Beverages': [
      ...
      {'name': 'Pepsi', 'price': 40, 'unit': '1 bottle', 'category': 'Beverages', 'image': 'assets/images/Beverages/big-cola.png'},
    ...
    {'name': 'Vanilla Ice Cream', 'price': 120, 'unit': '1 tub', 'category': 'Ice Creams', 'image': 'assets/images/Ice Creams/creamy-deliciousness.jpg'},
    ...
    'Biscuits': [
      ...
      {'name': 'Cookies', 'price': 35, 'unit': '100g', 'category': 'Biscuits', 'image': 'assets/images/Biscuits/Nice.jpg'},
      {'name': 'Rusk', 'price': 25, 'unit': '200g', 'category': 'Biscuits', 'image': 'assets/images/Biscuits/Milk Bikis.jpg'},
    ],
    ...
    'Namkeen': [
      ...
      {'name': 'Bingo', 'price': 20, 'unit': '100g', 'category': 'Namkeen', 'image': 'assets/images/Wafers/Bingo Mad Angles Masala Chips.jpg'},
    ],
    ...
    'Ketchup': [
      ...
      {'name': 'Mayonnaise', 'price': 90, 'unit': '250g', 'category': 'Ketchup', 'image': 'assets/categories/sauces_spreads.png'},
      {'name': 'Peanut Butter', 'price': 180, 'unit': '340g', 'category': 'Ketchup', 'image': 'assets/categories/sauces_spreads.png'},
      {'name': 'Honey', 'price': 150, 'unit': '250g', 'category': 'Ketchup', 'image': 'assets/categories/sauces_spreads.png'},
    ],
    'Shampoo': [
      ...
      {'name': 'Hair Oil', 'price': 299, 'unit': '200ml', 'category': 'Shampoo', 'image': 'assets/images/shampoo/Indulekha.jpg'},
      {'name': 'Conditioner', 'price': 280, 'unit': '185ml', 'category': 'Shampoo', 'image': 'assets/images/shampoo/Tresemme.png'},
      {'name': 'Hair Color', 'price': 350, 'unit': '175ml', 'category': 'Shampoo', 'image': 'assets/images/shampoo/Loreal.jpg'},
    ],
    'Soap': [
      ...
      {'name': 'Body Wash', 'price': 150, 'unit': '200ml', 'category': 'Soap', 'image': 'assets/images/personal use items/dove.png'},
      {'name': 'Shampoo', 'price': 170, 'unit': '180ml', 'category': 'Soap', 'image': 'assets/images/shampoo/Dove.png'},
      {'name': 'Toothpaste', 'price': 89, 'unit': '200g', 'category': 'Soap', 'image': 'assets/images/personal use items/Colgate.png'},
    ],
    'Personal Care': [
    ...
    'Clothes': [
      ...
      {'name': '3 Sando', 'price': 199, 'unit': '1 pc', 'category': 'Clothes', 'image': 'assets/images/cloths items/3 Sando.png'},
      ...
      {'name': 'Jacket', 'price': 1499, 'unit': '1 pc', 'category': 'Clothes', 'image': 'assets/images/cloths items/Jacket.png'},
      {'name': 'Light Blue tshirts', 'price': 299, 'unit': '1 pc', 'category': 'Clothes', 'image': 'assets/images/cloths items/Light Blue tshirts.png'},
    ...
    'Atta, Rice & Dal': [
      {'name': 'Atta', 'price': 280, 'unit': '5kg', 'category': 'Atta, Rice & Dal', 'image': 'assets/images/products/aata1.png'},
      {'name': 'Basmati Rice', 'price': 320, 'unit': '5kg', 'category': 'Atta, Rice & Dal', 'image': 'assets/images/products/rice1.png'},
      {'name': 'Toor Dal', 'price': 140, 'unit': '1kg', 'category': 'Atta, Rice & Dal', 'image': 'assets/images/products/daal1.png'},
      {'name': 'Moong Dal', 'price': 130, 'unit': '1kg', 'category': 'Atta, Rice & Dal', 'image': 'assets/images/products/daal2.png'},
      {'name': 'Chana Dal', 'price': 120, 'unit': '1kg', 'category': 'Atta, Rice & Dal', 'image': 'assets/images/products/daal3.png'},
    ],
    'Oil, Ghee & Masala': [
      {'name': 'Sunflower Oil', 'price': 180, 'unit': '1L', 'category': 'Oil, Ghee & Masala', 'image': 'assets/images/products/fortune.png'},
      {'name': 'Mustard Oil', 'price': 190, 'unit': '1L', 'category': 'Oil, Ghee & Masala', 'image': 'assets/images/products/oil.png'},
      {'name': 'Ghee', 'price': 250, 'unit': '500ml', 'category': 'Oil, Ghee & Masala', 'image': 'assets/images/products/goverdhanghee.png'},
      {'name': 'Turmeric', 'price': 40, 'unit': '200g', 'category': 'Oil, Ghee & Masala', 'image': 'assets/images/products/masala1.png'},
      {'name': 'Red Chilli', 'price': 45, 'unit': '200g', 'category': 'Oil, Ghee & Masala', 'image': 'assets/images/products/kalimirch.png'},
      {'name': 'Coriander Powder', 'price': 35, 'unit': '200g', 'category': 'Oil, Ghee & Masala', 'image': 'assets/images/products/mdhmasala.png'},
    ],
    'Dairy, Bread & Eggs': [
      {'name': 'Milk', 'price': 60, 'unit': '1L', 'category': 'Dairy, Bread & Eggs', 'image': 'assets/categories/dairy_bread_eggs.png'},
      {'name': 'Curd', 'price': 45, 'unit': '400g', 'category': 'Dairy, Bread & Eggs', 'image': 'assets/categories/dairy_bread_eggs.png'},
      {'name': 'Paneer', 'price': 90, 'unit': '200g', 'category': 'Dairy, Bread & Eggs', 'image': 'assets/categories/dairy_bread_eggs.png'},
      {'name': 'Bread', 'price': 45, 'unit': '400g', 'category': 'Dairy, Bread & Eggs', 'image': 'assets/categories/dairy_bread_eggs.png'},
      {'name': 'Brown Bread', 'price': 55, 'unit': '400g', 'category': 'Dairy, Bread & Eggs', 'image': 'assets/categories/dairy_bread_eggs.png'},
      {'name': 'Eggs', 'price': 70, 'unit': '6 pcs', 'category': 'Dairy, Bread & Eggs', 'image': 'assets/images/products/egg1.png'},
    ],
    'Dry Fruits & Cereals': [
      {'name': 'Almonds', 'price': 220, 'unit': '250g', 'category': 'Dry Fruits & Cereals', 'image': 'assets/images/products/dryfruit1.png'},
      {'name': 'Cashews', 'price': 250, 'unit': '250g', 'category': 'Dry Fruits & Cereals', 'image': 'assets/images/products/dryfruit2.png'},
      {'name': 'Raisins', 'price': 90, 'unit': '250g', 'category': 'Dry Fruits & Cereals', 'image': 'assets/images/products/dryfruit3.png'},
      {'name': 'Oats', 'price': 150, 'unit': '400g', 'category': 'Dry Fruits & Cereals', 'image': 'assets/images/products/dryfruit4.png'},
      {'name': 'Cornflakes', 'price': 210, 'unit': '475g', 'category': 'Dry Fruits & Cereals', 'image': 'assets/images/products/dryfruit5.png'},
      {'name': 'Muesli', 'price': 250, 'unit': '400g', 'category': 'Dry Fruits & Cereals', 'image': 'assets/images/products/dryfruit6.png'},
    ],
    'Kitchenware & Appliances': [
      {'name': 'Mixer Grinder', 'price': 2500, 'unit': '1 pc', 'category': 'Kitchenware & Appliances', 'image': 'assets/images/products/appliance1.png'},
      {'name': 'Pressure Cooker', 'price': 1200, 'unit': '1 pc', 'category': 'Kitchenware & Appliances', 'image': 'assets/images/products/cookware1.png'},
      {'name': 'Frying Pan', 'price': 450, 'unit': '1 pc', 'category': 'Kitchenware & Appliances', 'image': 'assets/images/products/cookware2.png'},
      {'name': 'Kettle', 'price': 699, 'unit': '1 pc', 'category': 'Kitchenware & Appliances', 'image': 'assets/images/products/appliance2.png'},
    ],
    'Chicken & Meat': [
      {'name': 'Chicken Breast', 'price': 250, 'unit': '500g', 'category': 'Chicken & Meat', 'image': 'assets/images/products/chicken1.png'},
      {'name': 'Chicken Curry Cut', 'price': 220, 'unit': '500g', 'category': 'Chicken & Meat', 'image': 'assets/images/products/chicken2.png'},
      {'name': 'Fish', 'price': 350, 'unit': '500g', 'category': 'Chicken & Meat', 'image': 'assets/images/products/fish1.png'},
      {'name': 'Mutton', 'price': 600, 'unit': '500g', 'category': 'Chicken & Meat', 'image': 'assets/images/products/mutton1.png'},
    ],
    'Tea, Coffee & Milk Drinks': [
      {'name': 'Tea', 'price': 140, 'unit': '500g', 'category': 'Tea, Coffee & Milk Drinks', 'image': 'assets/images/products/tea1.png'},
      {'name': 'Coffee', 'price': 180, 'unit': '100g', 'category': 'Tea, Coffee & Milk Drinks', 'image': 'assets/images/products/coffee1.png'},
      {'name': 'Bournvita', 'price': 220, 'unit': '500g', 'category': 'Tea, Coffee & Milk Drinks', 'image': 'assets/images/products/malt1.png'},
      {'name': 'Horlicks', 'price': 210, 'unit': '500g', 'category': 'Tea, Coffee & Milk Drinks', 'image': 'assets/images/products/malt2.png'},
    ],
    'Instant Food': [
      {'name': 'Maggi', 'price': 60, 'unit': '4 pack', 'category': 'Instant Food', 'image': 'assets/images/products/instant1.png'},
      {'name': 'Yippee', 'price': 55, 'unit': '4 pack', 'category': 'Instant Food', 'image': 'assets/images/products/instant2.png'},
      {'name': 'Pasta', 'price': 90, 'unit': '1 pack', 'category': 'Instant Food', 'image': 'assets/images/products/instant3.png'},
      {'name': 'Poha', 'price': 40, 'unit': '500g', 'category': 'Instant Food', 'image': 'assets/images/Namkeen/Poha chivda.png'},
    ],
    'Paan Corner': [
      {'name': 'Paan Masala', 'price': 10, 'unit': '1 pack', 'category': 'Paan Corner', 'image': 'assets/images/products/supari1.png'},
      {'name': 'Mouth Freshener', 'price': 20, 'unit': '1 pack', 'category': 'Paan Corner', 'image': 'assets/images/products/mint1.png'},
    ],
    'Skin & Face': [
      {'name': 'Face Wash', 'price': 150, 'unit': '100ml', 'category': 'Skin & Face', 'image': 'assets/images/products/facewash1.png'},
      {'name': 'Sunscreen', 'price': 250, 'unit': '50ml', 'category': 'Skin & Face', 'image': 'assets/images/products/sunscreen1.png'},
      {'name': 'Moisturizer', 'price': 220, 'unit': '150ml', 'category': 'Skin & Face', 'image': 'assets/images/personal use items/NIVEA.jpg'},
      {'name': 'Ponds Face Wash', 'price': 180, 'unit': '100ml', 'category': 'Skin & Face', 'image': 'assets/images/products/facewash2.png'},
      {'name': 'Himalaya Face Wash', 'price': 140, 'unit': '100ml', 'category': 'Skin & Face', 'image': 'assets/images/products/facewash3.png'},
      {'name': 'Lakme Moisturizer', 'price': 250, 'unit': '100ml', 'category': 'Skin & Face', 'image': 'assets/images/products/moisturizer2.png'},
      {'name': 'Nivea Soft Cream', 'price': 190, 'unit': '200ml', 'category': 'Skin & Face', 'image': 'assets/images/products/moisturizer3.png'},
      {'name': 'Lakme Sunscreen', 'price': 280, 'unit': '50ml', 'category': 'Skin & Face', 'image': 'assets/images/products/sunscreen2.png'},
      {'name': 'Neutrogena Sunscreen', 'price': 350, 'unit': '50ml', 'category': 'Skin & Face', 'image': 'assets/images/products/sunscreen3.png'},
      {'name': 'Face Mask Sheet', 'price': 40, 'unit': '1 pc', 'category': 'Skin & Face', 'image': 'assets/images/products/facemask1.png'},
      {'name': 'Charcoal Face Mask', 'price': 90, 'unit': '50g', 'category': 'Skin & Face', 'image': 'assets/images/products/facemask2.png'},
      {'name': 'Clay Face Mask', 'price': 110, 'unit': '50g', 'category': 'Skin & Face', 'image': 'assets/images/products/facemask3.png'},
    ],
    'Feminine Hygiene': [
      {'name': 'Sanitary Pads', 'price': 120, 'unit': '1 pack', 'category': 'Feminine Hygiene', 'image': 'assets/images/products/pad1.png'},
      {'name': 'Tampons', 'price': 150, 'unit': '1 pack', 'category': 'Feminine Hygiene', 'image': 'assets/images/products/tampons1.png'},
      {'name': 'Whisper Pads', 'price': 130, 'unit': '1 pack', 'category': 'Feminine Hygiene', 'image': 'assets/images/products/pad2.png'},
      {'name': 'Stayfree Pads', 'price': 140, 'unit': '1 pack', 'category': 'Feminine Hygiene', 'image': 'assets/images/products/pad3.png'},
      {'name': 'Tampons Regular', 'price': 160, 'unit': '1 pack', 'category': 'Feminine Hygiene', 'image': 'assets/images/products/tampons2.png'},
      {'name': 'Tampons Super', 'price': 170, 'unit': '1 pack', 'category': 'Feminine Hygiene', 'image': 'assets/images/products/tampons3.png'},
      {'name': 'Intimate Wash', 'price': 180, 'unit': '100ml', 'category': 'Feminine Hygiene', 'image': 'assets/images/products/intimate1.png'},
      {'name': 'VWash Plus', 'price': 190, 'unit': '100ml', 'category': 'Feminine Hygiene', 'image': 'assets/images/products/intimate2.png'},
      {'name': 'Intimate Wipes', 'price': 90, 'unit': '1 pack', 'category': 'Feminine Hygiene', 'image': 'assets/images/products/intimate3.png'},
      {'name': 'Menstrual Cup Small', 'price': 400, 'unit': '1 pc', 'category': 'Feminine Hygiene', 'image': 'assets/images/products/menstrualcup1.png'},
      {'name': 'Menstrual Cup Medium', 'price': 420, 'unit': '1 pc', 'category': 'Feminine Hygiene', 'image': 'assets/images/products/menstrualcup2.png'},
      {'name': 'Menstrual Cup Large', 'price': 450, 'unit': '1 pc', 'category': 'Feminine Hygiene', 'image': 'assets/images/products/menstrualcup3.png'},
    ],
    'Baby Care': [
      {'name': 'Diapers', 'price': 450, 'unit': '1 pack', 'category': 'Baby Care', 'image': 'assets/images/products/diaper1.png'},
      {'name': 'Baby Wipes', 'price': 120, 'unit': '1 pack', 'category': 'Baby Care', 'image': 'assets/images/products/babywipes1.png'},
      {'name': 'Baby Lotion', 'price': 150, 'unit': '200ml', 'category': 'Baby Care', 'image': 'assets/images/products/babyskincare1.png'},
      {'name': 'Pampers Diapers Large', 'price': 480, 'unit': '1 pack', 'category': 'Baby Care', 'image': 'assets/images/products/diaper2.png'},
      {'name': 'Huggies Diapers', 'price': 460, 'unit': '1 pack', 'category': 'Baby Care', 'image': 'assets/images/products/diaper3.png'},
      {'name': 'Cerelac Baby Food', 'price': 220, 'unit': '300g', 'category': 'Baby Care', 'image': 'assets/images/products/babyfood.png'},
      {'name': 'Nestle Baby Food', 'price': 210, 'unit': '300g', 'category': 'Baby Care', 'image': 'assets/images/products/babyfood2.png'},
      {'name': 'Farex Baby Food', 'price': 200, 'unit': '300g', 'category': 'Baby Care', 'image': 'assets/images/products/babyfood3.png'},
      {'name': 'Johnsons Baby Powder', 'price': 160, 'unit': '200g', 'category': 'Baby Care', 'image': 'assets/images/products/babyskincare2.png'},
      {'name': 'Baby Oil', 'price': 140, 'unit': '100ml', 'category': 'Baby Care', 'image': 'assets/images/products/babyskincare3.png'},
      {'name': 'Baby Wipes Refill', 'price': 100, 'unit': '1 pack', 'category': 'Baby Care', 'image': 'assets/images/products/babywipes2.png'},
      {'name': 'Baby Wipes Travel Pack', 'price': 60, 'unit': '1 pack', 'category': 'Baby Care', 'image': 'assets/images/products/babywipes3.png'},
    ],
    'Health & Pharma': [
      {'name': 'Whey Protein', 'price': 1899, 'unit': '1kg', 'category': 'Health & Pharma', 'image': 'assets/images/products/protein1.png'},
      {'name': 'Multivitamin', 'price': 300, 'unit': '30 tabs', 'category': 'Health & Pharma', 'image': 'assets/images/products/medi2.png'},
      {'name': 'Pain Relief', 'price': 45, 'unit': '1 strip', 'category': 'Health & Pharma', 'image': 'assets/images/products/firstaid1.png'},
      {'name': 'Antiseptic Cream', 'price': 55, 'unit': '1 tube', 'category': 'Health & Pharma', 'image': 'assets/images/products/firstaid2.png'},
      {'name': 'Bandage Pack', 'price': 45, 'unit': '1 pack', 'category': 'Health & Pharma', 'image': 'assets/images/products/firstaid3.png'},
      {'name': 'Digestive Tablets', 'price': 65, 'unit': '10 tabs', 'category': 'Health & Pharma', 'image': 'assets/images/products/medi3.png'},
      {'name': 'Protein Bar', 'price': 60, 'unit': '1 pc', 'category': 'Health & Pharma', 'image': 'assets/images/products/protein2.png'},
      {'name': 'BCAA Supplement', 'price': 999, 'unit': '250g', 'category': 'Health & Pharma', 'image': 'assets/images/products/protein3.png'},
    ],
    'Home & Lifestyle': [
      {'name': 'Plant Pot', 'price': 199, 'unit': '1 pc', 'category': 'Home & Lifestyle', 'image': 'assets/images/products/plant1.png'},
      {'name': 'Storage Box', 'price': 300, 'unit': '1 pc', 'category': 'Home & Lifestyle', 'image': 'assets/images/products/container1.png'},
      {'name': 'Air Freshener', 'price': 150, 'unit': '1 pc', 'category': 'Home & Lifestyle', 'image': 'assets/images/products/homedecore1.png'},
      {'name': 'Bedsheet Set', 'price': 599, 'unit': '1 pc', 'category': 'Home & Lifestyle', 'image': 'assets/images/products/bedlinen.png'},
      {'name': 'Pillow Covers', 'price': 199, 'unit': '2 pcs', 'category': 'Home & Lifestyle', 'image': 'assets/images/products/bedlinen2.png'},
      {'name': 'Comforter', 'price': 899, 'unit': '1 pc', 'category': 'Home & Lifestyle', 'image': 'assets/images/products/bedlinen3.png'},
      {'name': 'Wall Clock', 'price': 349, 'unit': '1 pc', 'category': 'Home & Lifestyle', 'image': 'assets/images/products/homedecore2.png'},
      {'name': 'Photo Frame', 'price': 199, 'unit': '1 pc', 'category': 'Home & Lifestyle', 'image': 'assets/images/products/homedecore3.png'},
      {'name': 'Storage Basket', 'price': 250, 'unit': '1 pc', 'category': 'Home & Lifestyle', 'image': 'assets/images/products/storagesolution1.png'},
      {'name': 'Storage Box Set', 'price': 450, 'unit': '3 pcs', 'category': 'Home & Lifestyle', 'image': 'assets/images/products/storagesolution2.png'},
      {'name': 'Storage Organizer', 'price': 300, 'unit': '1 pc', 'category': 'Home & Lifestyle', 'image': 'assets/images/products/storagesolution3.png'},
      {'name': 'Indoor Plant', 'price': 249, 'unit': '1 pc', 'category': 'Home & Lifestyle', 'image': 'assets/images/products/plant2.png'},
      {'name': 'Succulent Plant', 'price': 149, 'unit': '1 pc', 'category': 'Home & Lifestyle', 'image': 'assets/images/products/plant3.png'},
    ],
    'Cleaners & Repellents': [
      {'name': 'Surf Excel', 'price': 220, 'unit': '1kg', 'category': 'Cleaners & Repellents', 'image': 'assets/images/personal use items/Surf excel.png'},
      {'name': 'Harpic', 'price': 90, 'unit': '500ml', 'category': 'Cleaners & Repellents', 'image': 'assets/images/products/floorcleanser1.png'},
      {'name': 'Lizol', 'price': 150, 'unit': '1L', 'category': 'Cleaners & Repellents', 'image': 'assets/images/products/floorcleanser2.png'},
      {'name': 'Mosquito Repellent', 'price': 60, 'unit': '1 pack', 'category': 'Cleaners & Repellents', 'image': 'assets/images/products/Mosquitorepellents1.png'},
      {'name': 'Colin Floor Cleaner', 'price': 110, 'unit': '500ml', 'category': 'Cleaners & Repellents', 'image': 'assets/images/products/floorcleanser3.png'},
      {'name': 'Ariel Detergent', 'price': 210, 'unit': '1kg', 'category': 'Cleaners & Repellents', 'image': 'assets/images/products/detergent1.png'},
      {'name': 'Tide Detergent', 'price': 195, 'unit': '1kg', 'category': 'Cleaners & Repellents', 'image': 'assets/images/products/detergent2.png'},
      {'name': 'Rin Detergent', 'price': 150, 'unit': '1kg', 'category': 'Cleaners & Repellents', 'image': 'assets/images/products/detergent3.png'},
      {'name': 'Vim Dishwash Gel', 'price': 99, 'unit': '500ml', 'category': 'Cleaners & Repellents', 'image': 'assets/images/products/dishwash1.png'},
      {'name': 'Vim Bar', 'price': 20, 'unit': '1 pc', 'category': 'Cleaners & Repellents', 'image': 'assets/images/products/dishwash2.png'},
      {'name': 'Pril Dishwash', 'price': 105, 'unit': '500ml', 'category': 'Cleaners & Repellents', 'image': 'assets/images/products/dishwash3.png'},
      {'name': 'Good Knight Repellent', 'price': 65, 'unit': '1 pc', 'category': 'Cleaners & Repellents', 'image': 'assets/images/products/Mosquitorepellents2.png'},
      {'name': 'All Out Repellent', 'price': 70, 'unit': '1 pc', 'category': 'Cleaners & Repellents', 'image': 'assets/images/products/Mosquitorepellents3.png'},
    ],
    'Electronics': [
      {'name': 'Earbuds', 'price': 999, 'unit': '1 pc', 'category': 'Electronics', 'image': 'assets/images/products/earphone1.png'},
      {'name': 'Charger', 'price': 399, 'unit': '1 pc', 'category': 'Electronics', 'image': 'assets/images/products/charger1.png'},
      {'name': 'Power Bank', 'price': 1299, 'unit': '1 pc', 'category': 'Electronics', 'image': 'assets/images/products/batteries1.png'},
      {'name': 'Wired Earphones', 'price': 299, 'unit': '1 pc', 'category': 'Electronics', 'image': 'assets/images/products/earphone2.png'},
      {'name': 'Bluetooth Headphones', 'price': 1499, 'unit': '1 pc', 'category': 'Electronics', 'image': 'assets/images/products/earphone3.png'},
      {'name': 'Type-C Charger', 'price': 449, 'unit': '1 pc', 'category': 'Electronics', 'image': 'assets/images/products/charger2.png'},
      {'name': 'Fast Charger', 'price': 599, 'unit': '1 pc', 'category': 'Electronics', 'image': 'assets/images/products/charger3.png'},
      {'name': 'AA Batteries', 'price': 80, 'unit': '4 pcs', 'category': 'Electronics', 'image': 'assets/images/products/batteries2.png'},
      {'name': 'AAA Batteries', 'price': 75, 'unit': '4 pcs', 'category': 'Electronics', 'image': 'assets/images/products/batteries3.png'},
      {'name': 'LED Bulb 9W', 'price': 99, 'unit': '1 pc', 'category': 'Electronics', 'image': 'assets/images/products/bulb1.png'},
      {'name': 'LED Bulb 12W', 'price': 129, 'unit': '1 pc', 'category': 'Electronics', 'image': 'assets/images/products/bulb2.png'},
      {'name': 'Smart Bulb', 'price': 399, 'unit': '1 pc', 'category': 'Electronics', 'image': 'assets/images/products/bulb3.png'},
    ],
    'Stationery & Games': [
      {'name': 'Notebook', 'price': 60, 'unit': '1 pc', 'category': 'Stationery & Games', 'image': 'assets/images/products/notebook1.png'},
      {'name': 'Pen', 'price': 10, 'unit': '1 pc', 'category': 'Stationery & Games', 'image': 'assets/images/products/art1.png'},
      {'name': 'UNO', 'price': 150, 'unit': '1 pack', 'category': 'Stationery & Games', 'image': 'assets/images/toys items/Board GameHasbro.png'},
      {'name': 'Puzzle', 'price': 250, 'unit': '1 pc', 'category': 'Stationery & Games', 'image': 'assets/images/toys items/Puzzle Game Funskool.jpg'},
      {'name': 'Sketch Book', 'price': 80, 'unit': '1 pc', 'category': 'Stationery & Games', 'image': 'assets/images/products/notebook2.png'},
      {'name': 'Diary', 'price': 120, 'unit': '1 pc', 'category': 'Stationery & Games', 'image': 'assets/images/products/notebook3.png'},
      {'name': 'Playing Cards', 'price': 40, 'unit': '1 pack', 'category': 'Stationery & Games', 'image': 'assets/images/products/cards1.png'},
      {'name': 'Chess Board', 'price': 250, 'unit': '1 pc', 'category': 'Stationery & Games', 'image': 'assets/images/products/cards2.png'},
      {'name': 'Ludo', 'price': 150, 'unit': '1 pc', 'category': 'Stationery & Games', 'image': 'assets/images/products/cards3.png'},
      {'name': 'Crayons Set', 'price': 60, 'unit': '1 pack', 'category': 'Stationery & Games', 'image': 'assets/images/products/art2.png'},
      {'name': 'Sketch Pens', 'price': 90, 'unit': '1 pack', 'category': 'Stationery & Games', 'image': 'assets/images/products/art3.png'},
      {'name': 'Toy Car', 'price': 199, 'unit': '1 pc', 'category': 'Stationery & Games', 'image': 'assets/images/products/toys1.png'},
      {'name': 'Building Blocks', 'price': 349, 'unit': '1 pack', 'category': 'Stationery & Games', 'image': 'assets/images/products/toys2.png'},
      {'name': 'Soft Toy', 'price': 299, 'unit': '1 pc', 'category': 'Stationery & Games', 'image': 'assets/images/products/toys3.png'},
    ],
  };
